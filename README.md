...
A continuación queda un vídeo en el que podemos ver el código empleado para la realización de la práctica en funcionamiento, en el cual se muestra la efectividad de la imlementación hecha para todo aquello explicado previamente:
